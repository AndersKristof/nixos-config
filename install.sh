...
nix run home-manager/master -- switch --flake "$SCRIPT_DIR#user"

echo ""
echo "=== Installation Complete! ==="
echo "Your NixOS system has been configured with flakes and home-manager."
echo ""
...
echo "  3. Run: home-manager switch --flake $SCRIPT_DIR#user"
echo ""
